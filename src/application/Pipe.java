...
public class Pipe {
	...
	double w;
	double l;
	public Pipe(PathNode start, PathNode end,int selectedwall,int selectedwall2,double w, double l) {
		this.start=start;
		this.end=end;
	...
	public void inBlock(PathNode a)
	{
		if(selectedwall==selectedwall2+1) {
			if(selectedwall2==0) {
				if(a.getX()>this.l) {
					System.out.println(a.getX()-l);
				}
